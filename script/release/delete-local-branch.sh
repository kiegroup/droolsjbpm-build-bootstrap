...
echo "Be aware that you only can delete branches you are not working on"
echo -n "Hit control-c if you have to checkout other branches or type ok to continue): "
echo -n ""
echo -n ""
read ok
