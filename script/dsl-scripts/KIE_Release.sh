def releasePrepare =
"""
sh droolsjbpm-build-bootstrap/script/release/01.KIE_releasePrepare.sh
"""

def pushReleaseBranches =
"""
sh droolsjbpm-build-bootstrap/script/release/02.KIE_pushReleaseBranches.sh
"""

def deployLocally=
"""
sh droolsjbpm-build-bootstrap/script/release/03.KIE_deployLocally.sh
"""

def copyToNexus=
"""
sh droolsjbpm-build-bootstrap/script/release/04.KIE_copyToNexus.sh
"""
...
def pushTags=
"""
sh droolsjbpm-build-bootstrap/script/release/05.KIE_pushTag.sh
"""
def removeBranches=
"""
sh droolsjbpm-build-bootstrap/script/release/06.KIE_removeReleaseBranches.sh
"""
...
job("01.releasePrepare") {
  ...
  customWorkspace("\$HOME/workspace/KIE-Release-6.5.x")
...
matrixJob("04a.allJbpmTestCoverageMatrix") {
  ...
  steps {
    ...
    maven{
      ...
      goals("clean verify -e -B -Djdk.min.version=1.6 -Dmaven.test.failure.ignore=true -Dintegration-tests")
