...
2. Reads PNC Build Configuration
3. Executes PME
...
This step is executed once per project getting the PME configuration from the build configuration file. The jar path is taken from PME_CLI_PATH 
